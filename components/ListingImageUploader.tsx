...
export default function ListingImageUploader({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {/* Render `max` cells so the multi (shop) capacity is visible up front —
          filled photos first, then empty "Add photo" tiles for the rest. Thrift
          (max=1) shows a single cell. Adding fills left-to-right. */}
